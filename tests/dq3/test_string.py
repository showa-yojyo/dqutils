...
class DQ3StringTestCase(TestCase):
    ...
    def test_get_text(self):
        ...
        text = get_text(b"\x26\x24\x12\x24\xdc\x0e\xac", CONTEXT["charmap"], CONTEXT["delimiters"])
    ...
    def test_enum_string(self):
        ...
        self.assertTrue("せいすい" in get_text(testdata[0][1], CONTEXT["charmap"], CONTEXT["delimiters"]))

        self.assertEqual(testdata[15][0], 0xFED6CA)
        self.assertTrue("にじのしずく" in get_text(testdata[15][1], CONTEXT["charmap"], CONTEXT["delimiters"]))
