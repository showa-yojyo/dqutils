...
CONTEXT_MESSAGE_BATTLE: Final[MsgGenContext] = {
    "title": "DRAGONQUEST5",
...
def enum_battle(first: int = INVALID_ID, last: int = INVALID_ID) -> IteratorT:
...
def print_all_battle() -> None:
    ...
    first, last = context["id_first"], context["id_last"]
